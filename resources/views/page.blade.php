...
<!-- {{asset('temp/')}} -->
  <head>
    ...
    <link rel="stylesheet" href="{{asset('temp/assets/css/templatemo-seo-dream.css')}}">
    <link rel="stylesheet" href="{{asset('temp/assets/css/animated.css')}}">
...
<body>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <h4>SISDO INTRa <img src="{{asset('temp/assets/images/logo-icon.png')}}" alt=""></h4>
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="{{asset('temp/assets/images/banner-right-image.png')}}" alt="">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
            <img src="{{asset('temp/assets/images/about-left-image.png')}}" alt="">
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
            <div class="row">
              <div class="col-lg-4">
                <div class="icon">
                  <img src="{{asset('temp/assets/images/service-icon-01.png')}}" alt="">
                </div>
              </div>
              <div class="col-lg-8">
        ...
        <div class="col-lg-4">
          <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.4s">
            <div class="row">
              <div class="col-lg-4">
                <div class="icon">
                  <img src="{{asset('temp/assets/images/service-icon-02.png')}}" alt="">
                </div>
              </div>
              <div class="col-lg-8">
                <div class="right-content">
        ...
        <div class="col-lg-4">
          <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.5s">
            <div class="row">
              <div class="col-lg-4">
                <div class="icon">
                  <img src="{{asset('temp/assets/images/service-icon-03.png')}}" alt="">
                </div>
              </div>
              <div class="col-lg-8">
                <div class="right-content">
          ...
          <div class="loop owl-carousel">
            <div class="item">
              <div class="portfolio-item">
                <div class="thumb">
                  <img src="{{asset('temp/assets/images/portfolio-01.jpg')}}" alt="">
              ...
              <div class="portfolio-item">
                <div class="thumb">
                  <img src="{{asset('temp/assets/images/portfolio-04.jpg')}}" alt="">
                  <div class="hover-content">
                    <div class="inner-content">
            ...
            <div class="item">
              <div class="portfolio-item">
                <div class="thumb">
                  <img src="{{asset('temp/assets/images/portfolio-02.jpg')}}" alt="">
                  <div class="hover-content">
                    <div class="inner-content">
              ...
              <div class="portfolio-item">
                <div class="thumb">
                  <img src="{{asset('temp/assets/images/portfolio-05.jpg')}}" alt="">
                  <div class="hover-content">
                    <div class="inner-content">
            ...
            <div class="item">
              <div class="portfolio-item">
                <div class="thumb">
                  <img src="{{asset('temp/assets/images/portfolio-03.jpg')}}" alt="">
                  <div class="hover-content">
                    <div class="inner-content">
              ...
              <div class="portfolio-item">
                <div class="thumb">
                  <img src="{{asset('temp/assets/images/portfolio-06.jpg')}}" alt="">
                  <div class="hover-content">
                    <div class="inner-content">
              ...
              <div class="col-lg-3">
                <div class="contact-info">
                  <ul>
                    <li>
                      <div class="icon">
                        <img src="{{asset('temp/assets/images/contact-icon-01.png')}}" alt="email icon">
                      </div>
                      <a href="#">info@company.com</a>
                    </li>
                    <li>
                      <div class="icon">
                        <img src="{{asset('temp/assets/images/contact-icon-02.png')}}" alt="phone">
                      </div>
                      <a href="#">+001-002-0034</a>
                    </li>
                    <li>
                      <div class="icon">
                        <img src="{{asset('temp/assets/images/contact-icon-03.png')}}" alt="location">
                      </div>
  ...
  <script src="{{asset('temp/assets/js/animation.js')}}"></script>
  <script src="{{asset('temp/assets/js/imagesloaded.js')}}"></script>
